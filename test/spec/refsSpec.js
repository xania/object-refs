...
describe('refs', function() {
  ...
  describe('one-to-one', function() {
    ...
    it('should define non-configurable property per default', function() {
      ...
      // given
      var configurableRefs = new Refs({ name: 'foo' }, { name: 'bar' });
    ...
    it('should define configurable property', function() {
      ...
      // given
      var configurableRefs = new Refs({ name: 'foo', configurable: true }, { name: 'bar' });
    ...
    it.only('should create bi-directional configurable property', function() {
